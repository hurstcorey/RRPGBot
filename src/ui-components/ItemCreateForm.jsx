...
export default function ItemCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setCost_amount(initialValues.cost_amount);
    setRarity_id(initialValues.rarity_id);
    setItem_type_id(initialValues.item_type_id);
    setMagic_element_id(initialValues.magic_element_id);
    setCharacter_attribute_id(initialValues.character_attribute_id);
    setCharacter_attribute_modifer(initialValues.character_attribute_modifer);
    setCursed_id(initialValues.cursed_id);
    setInsert_timestamp_UTC(initialValues.insert_timestamp_UTC);
    setUpdate_timestamp_UTC(initialValues.update_timestamp_UTC);
    setErrors({});
  };
  const validations = {
    name: [],
